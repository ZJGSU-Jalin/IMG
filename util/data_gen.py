...
def gen_or_load_dataset(configs,new_json,old_json):
    ...
    val_set = None if val_data is None else dataset_gen(val_data, old_vfeat_lens, word_dict, char_dict,
                                                        configs.max_pos_len, 'val')
    test_set = dataset_gen(test_data, old_vfeat_lens, word_dict, char_dict, configs.max_pos_len, 'test')
    # save dataset
